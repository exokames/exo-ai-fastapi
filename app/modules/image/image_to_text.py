...
from app.core.exceptions import ImageToTextError


class ImageToText:
    """A class to handle image-to-text conversion using Google's vision capabilities."""
    ...
    async def analyze_image(self, image_data: Union[str, bytes], prompt: str = "") -> str:
        """Analyze an image using Google's vision capabilities.
